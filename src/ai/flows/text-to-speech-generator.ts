'use server';
/**
 * @fileOverview An AI-powered Text-to-Speech (TTS) generator.
 *
 * - generateAudioFromText - Converts text to a playable audio data URI.
...
const textToSpeechFlow = ai.defineFlow(
  ...
  async ({ text }) => {
    ...
    if (!media?.url) {
      throw new Error('Audio generation failed to return media.');
    }
